...
A1_mom111 = [
    (1, 'S_pipi', [[1, 1, 1], [0, 0, 0]]), # 3 units rel (.614)
...
OPLIST = {'A_1PLUS_mom000': A_1PLUS_mom000,
          ...
          'A1x_mom100': A1z_mom100,
          'A1y_mom010': A1z_mom010,
          'A1x_mom011': A1x_mom011,
          'A1y_mom101': A1y_mom101,
          'A1z_mom110': A1y_mom110,
          'A1_mom111': A1_mom111,
...
AVG_ROWS = {
    ...
    'A1_mom11': ('A1x_mom011', 'A1y_mom101', 'A1z_mom110'),
    'A1_mom1': ('A1z_mom001', 'A1y_mom010', 'A1z_mom001'),
