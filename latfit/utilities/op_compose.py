...
A1_mom111 = [
    (1/sqrt(2), 'S_pipi', [[1, 1, 1], [0, 0, 0]]), # 3 units rel (.614)
    (1/sqrt(2), 'S_pipi', [[0, 0, 0], [1, 1, 1]]),
    (1/sqrt(6), 'pipi', [[1, 0, 0], [0, 1, 1]]), # 3 units rel (.692)
...
A1x_mom011 = [
    (1/sqrt(2), 'S_pipi', [[0, 0, 0], [0, 1, 1]]), # 2 units rel (efree_24c=.396)
    (1/sqrt(2), 'S_pipi', [[0, 1, 1], [0, 0, 0]]),
    (1/sqrt(2), 'pipi', [[0, 1, 0], [0, 0, 1]]), # 2 units rel (.594)
    (1/sqrt(2), 'pipi', [[0, 0, 1], [0, 1, 0]]),
    (1, 'sigma', [0, 1, 1]), # sigma
    (0.5, 'UUpipi', [[1, 0, 0], [-1, 1, 1]]), # 4 units rel (efree_24=.77)
...
A1z_mom001 = [
    (1/sqrt(2), 'S_pipi', [[0, 0, 0], [0, 0, 1]]), # 1 unit rel (.3)
    (1/sqrt(2), 'S_pipi', [[0, 0, 1], [0, 0, 0]]),
    (1/sqrt(8), 'pipi', [[-1, 0, 1], [1, 0, 0]]), # 3 unit rel (.693)
    ...
    (1/sqrt(8), 'pipi', [[0, 1, 1],[0, -1, 0]]),
    (1/sqrt(8), 'pipi', [[0, -1, 0], [0, 1, 1]]),
    (1/sqrt(8), 'pipi', [[1, 1, 0], [-1, -1, 1]]), # 6 unit rel (.870)
    (1/sqrt(8), 'pipi', [[-1, -1, 1], [1, 1, 0]]),
    (1/sqrt(8), 'pipi', [[1, -1, 0], [-1, 1, 1]]),
    (1/sqrt(8), 'pipi', [[-1, 1, 1], [1, -1, 0]]),
    (1/sqrt(8), 'pipi', [[-1, 1, 0], [1, -1, 1]]),
    (1/sqrt(8), 'pipi', [[1, -1, 1], [-1, 1, 0]]),
    (1/sqrt(8), 'pipi', [[-1, -1, 0], [1, 1, 1]]),
    (1/sqrt(8), 'pipi', [[1, 1, 1], [-1, -1, 0]]),
    (1, 'sigma', [0, 0, 1]), # sigma ?
    (1/sqrt(2), 'UUpipi', [[0, 0, 2], [0, 0, -1]]), # 3 unit rel (.8388)
    (1/sqrt(2), 'UUpipi', [[0, 0, -1], [0, 0, 2]]),
]
"""
    (1/sqrt(8), 'U2pipi', [[0, -1, 2], [0, 1, -1]]), # 5 unit rel (1)
    ...
    (1/sqrt(8), 'U2pipi', [[1, 0, 2], [-1, 0, -1]]),
    (1/sqrt(8), 'U2pipi', [[-1, 0, -1], [1, 0, 2]]),
    (1/sqrt(8), 'U3pipi', [[-2, 0, 1], [2, 0, 0]]), # 5 unit rel (1.14)
    ...
    (1/sqrt(8), 'U4pipi', [[1, 1, -1], [-1, -1, 2]]), # 7 unit rel (1.13)
