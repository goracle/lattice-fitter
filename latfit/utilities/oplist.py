...
if ENSEMBLE == '24ID':
    ...
    T_1_1MINUS_mom000_check = [
        (-0.7071067812, 'pipi', [[-1, 0, 0], [1, 0, 0]]),
        (0.7071067812, 'pipi', [[1, 0, 0], [-1, 0, 0]]),
        (-0.3535533906, 'UUpipi', [[-1, -1, 0], [1, 1, 0]]),
        (-0.3535533906, 'UUpipi', [[-1, 0, -1], [1, 0, 1]]),
        (-0.3535533906, 'UUpipi', [[-1, 0, 1], [1, 0, -1]]),
        (-0.3535533906, 'UUpipi', [[-1, 1, 0], [1, -1, 0]]),
        (0.3535533906, 'UUpipi', [[1, -1, 0], [-1, 1, 0]]),
        (0.3535533906, 'UUpipi', [[1, 0, -1], [-1, 0, 1]]),
        (0.3535533906, 'UUpipi', [[1, 0, 1], [-1, 0, -1]]),
        (0.3535533906, 'UUpipi', [[1, 1, 0], [-1, -1, 0]]),
        (-0.3535533906, 'U2pipi', [[-1, -1, -1], [1, 1, 1]]),
        (-0.3535533906, 'U2pipi', [[-1, -1, 1], [1, 1, -1]]),
        (-0.3535533906, 'U2pipi', [[-1, 1, -1], [1, -1, 1]]),
        (-0.3535533906, 'U2pipi', [[-1, 1, 1], [1, -1, -1]]),
        (0.3535533906, 'U2pipi', [[1, -1, -1], [-1, 1, 1]]),
    ...
    T_1_2MINUS_mom000_check = [
        (-0.7071067812, 'pipi', [[0, -1, 0], [0, 1, 0]]),
        (0.7071067812, 'pipi', [[0, 1, 0], [0, -1, 0]]),
        (-0.3535533906, 'UUpipi', [[-1, -1, 0], [1, 1, 0]]),
        (0.3535533906, 'UUpipi', [[-1, 1, 0], [1, -1, 0]]),
        (-0.3535533906, 'UUpipi', [[0, -1, -1], [0, 1, 1]]),
        (-0.3535533906, 'UUpipi', [[0, -1, 1], [0, 1, -1]]),
        (0.3535533906, 'UUpipi', [[0, 1, -1], [0, -1, 1]]),
        (0.3535533906, 'UUpipi', [[0, 1, 1], [0, -1, -1]]),
        (-0.3535533906, 'UUpipi', [[1, -1, 0], [-1, 1, 0]]),
    ...
    T_1_3MINUS_mom000_check = [
        (-0.7071067812, 'pipi', [[0, 0, -1], [0, 0, 1]]),
        (0.7071067812, 'pipi', [[0, 0, 1], [0, 0, -1]]),
        (-0.3535533906, 'UUpipi', [[-1, 0, -1], [1, 0, 1]]),
        (0.3535533906, 'UUpipi', [[-1, 0, 1], [1, 0, -1]]),
        (-0.3535533906, 'UUpipi', [[0, -1, -1], [0, 1, 1]]),
...
# (too large to be used in a2a production for the forseeable future)
elif ENSEMBLE == 'FULL':
...
OPLIST.update({'A_1PLUS_mom000': A_1PLUS_mom000,
               ...
               'T_1_2MINUS_mom000?pol=2': T_1_2MINUS_mom000,
               'T_1_3MINUS_mom000?pol=3': T_1_3MINUS_mom000,})
# 'A0_mom000': A0_mom000,
# 'A2': A2,
# 'A1x': A1x,
# 'A1mx': A1mx,
...
CHECKDICT = {}
ORIGDICT = {}
for tup in T_1_3MINUS_mom000_check:
    CHECKDICT[str(tup[2])] = tup
for tup in T_1_3MINUS_mom000:
    key = str(tup[2])
    if key != '[0, 0, 0]':
        ORIGDICT[key] = tup
        assert np.allclose(ORIGDICT[key][0], CHECKDICT[key][0], rtol=1e-8)
